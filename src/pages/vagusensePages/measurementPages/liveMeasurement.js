...
const LiveMeasurement = ({ navigation, route }) => {
    ...
    const sentData = (ppg, skinResponse) => {
        ...
        fetch(CONFIG.baseServer + 'api/ppgs/live', {
            method: 'POST',
            headers: {
            ...
            .then((responseData) => {
                ...
                setHrDataSource(hrDataSource => [...hrDataSource, parseFloat(responseData["HR"])]);
                setRmssdDataSource(rmssdDataSource => [...rmssdDataSource, parseFloat(responseData["rMSSD"])]);
                setLfhfDataSource(lfhfDataSource => [...lfhfDataSource, parseFloat(responseData["lf/hf"])]);
                setSkinResponseDataSource(skinResponseDataSource => [...skinResponseDataSource, parseFloat(responseData["skinResponse"])]);
